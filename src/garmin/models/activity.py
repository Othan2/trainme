...
class Activity(BaseModel):
    ...
    end_time_gmt: Optional[str] = Field(default=None, description="GMT end time of the activity")
    ...
    elapsed_duration: Optional[float] = Field(default=None, description="Elapsed duration in seconds")
    moving_duration: Optional[float] = Field(default=None, description="Moving duration in seconds")
    
    # Elevation
    elevation_gain: Optional[float] = Field(default=None, description="Elevation gain in meters")
    elevation_loss: Optional[float] = Field(default=None, description="Elevation loss in meters")
    min_elevation: Optional[float] = Field(default=None, description="Minimum elevation in meters")
    max_elevation: Optional[float] = Field(default=None, description="Maximum elevation in meters")
    
    # Speed
    average_speed: Optional[float] = Field(default=None, description="Average speed in m/s")
    max_speed: Optional[float] = Field(default=None, description="Maximum speed in m/s")
    max_vertical_speed: Optional[float] = Field(default=None, description="Maximum vertical speed")
    ...
    owner_profile_image_url_small: Optional[str] = Field(default=None, description="Small profile image URL")
    owner_profile_image_url_medium: Optional[str] = Field(default=None, description="Medium profile image URL")
    owner_profile_image_url_large: Optional[str] = Field(default=None, description="Large profile image URL")
    ...
    # Running specific
    average_running_cadence_in_steps_per_minute: Optional[float] = Field(default=None, description="Average cadence")
    max_running_cadence_in_steps_per_minute: Optional[float] = Field(default=None, description="Maximum cadence")
    max_double_cadence: Optional[float] = Field(default=None, description="Maximum double cadence")
    steps: Optional[int] = Field(default=None, description="Total steps")
    avg_stride_length: Optional[float] = Field(default=None, description="Average stride length")
    ...
    # Training effects
    aerobic_training_effect: Optional[float] = Field(default=None, description="Aerobic training effect")
    anaerobic_training_effect: Optional[float] = Field(default=None, description="Anaerobic training effect")
    aerobic_training_effect_message: Optional[str] = Field(default=None, description="Aerobic training effect message")
    anaerobic_training_effect_message: Optional[str] = Field(default=None, description="Anaerobic training effect message")
    training_effect_label: Optional[str] = Field(default=None, description="Training effect label")
    activity_training_load: Optional[float] = Field(default=None, description="Activity training load")
    
    # Environmental
    min_temperature: Optional[float] = Field(default=None, description="Minimum temperature")
    max_temperature: Optional[float] = Field(default=None, description="Maximum temperature")
    water_estimated: Optional[float] = Field(default=None, description="Estimated water consumption")
    
    # Performance metrics
    vo2_max_value: Optional[float] = Field(default=None, description="VO2 max value")
    fastest_split_1000: Optional[float] = Field(default=None, description="Fastest 1000m split time")
    fastest_split_1609: Optional[float] = Field(default=None, description="Fastest mile split time")
    
    # Heart rate zones
    hr_time_in_zone_1: Optional[float] = Field(default=None, description="Time in HR zone 1")
    hr_time_in_zone_2: Optional[float] = Field(default=None, description="Time in HR zone 2")
    hr_time_in_zone_3: Optional[float] = Field(default=None, description="Time in HR zone 3")
    hr_time_in_zone_4: Optional[float] = Field(default=None, description="Time in HR zone 4")
    hr_time_in_zone_5: Optional[float] = Field(default=None, description="Time in HR zone 5")
    
    # Intensity minutes
    moderate_intensity_minutes: Optional[int] = Field(default=None, description="Moderate intensity minutes")
    vigorous_intensity_minutes: Optional[int] = Field(default=None, description="Vigorous intensity minutes")
    
    # Lap and split data
    lap_count: Optional[int] = Field(default=None, description="Number of laps")
    min_activity_lap_duration: Optional[float] = Field(default=None, description="Minimum lap duration")
    split_summaries: Optional[List[SplitSummary]] = Field(default=None, description="Split summaries")
    has_splits: bool = Field(default=False, description="Whether activity has splits")
    
    # Flags
    has_polyline: bool = Field(default=False, description="Whether activity has GPS polyline")
    ...
    has_heat_map: bool = Field(default=False, description="Whether activity has heat map")
    user_pro: bool = Field(default=False, description="Whether user is pro")
    purposeful: bool = Field(default=False, description="Whether activity is purposeful")
    manual_activity: bool = Field(default=False, description="Whether activity was manually entered")
    auto_calc_calories: bool = Field(default=False, description="Whether calories were auto-calculated")
    elevation_corrected: bool = Field(default=False, description="Whether elevation was corrected")
    atp_activity: bool = Field(default=False, description="Whether it's an ATP activity")
    ...
    parent: bool = Field(default=False, description="Whether activity is a parent activity")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        optional_fields = [
            ...
            ("maxHR", self.max_hr),
            ("averageRunningCadenceInStepsPerMinute", self.average_running_cadence_in_steps_per_minute),
            ("maxRunningCadenceInStepsPerMinute", self.max_running_cadence_in_steps_per_minute),
        ...
        if self.split_summaries:
            result["splitSummaries"] = [split.to_dict() for split in self.split_summaries]
